 ...
 * @author Abdelaziz
 */
public class AddCategoryForm extends SideMenuBaseForm {
    public AddCategoryForm(Resources res , Form previous , int addForm, String nomCateg, int id) {
        super(BoxLayout.y());
        ...
        if (addForm == 1 ) {
            ...
            TextField name = new TextField("", "Name Category", 16, TextArea.ANY); 
                ...
                public void actionPerformed(ActionEvent evt) {
                    ...
                    else
                    {
                        try {
                            ...
                            Categorie t = new Categorie(1, name.getText() );

                            if( ServiceCategories.getInstance().addCategory(t))
                            {
            ...
            add.addActionListener(new ActionListener() {
                ...
                public void actionPerformed(ActionEvent evt) {
                    ...
                    else
                    {
                        try {
                            //Dialog.show("Success","Thank you for your review.",new Command("OK"));
                            Categorie t = new Categorie(id, name.getText() );

                            if( ServiceCategories.getInstance().editCategory(t))
                            {
                               Dialog.show("Success","Category has been edited successfully.",new Command("OK"));
                            }else
                                Dialog.show("ERROR", "Server error", new Command("OK"));
                        } catch (NumberFormatException e) {
                            Dialog.show("ERROR", " ", new Command("OK"));
