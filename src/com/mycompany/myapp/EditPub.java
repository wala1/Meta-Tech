...
public class EditPub extends SideMenuBaseForm {
    ...
    public EditPub(Resources res, Publication publication) {
        ...
        TextField titre = new TextField(publication.getTitre(), "Titre ...");
        ...
        TextField description = new TextField(publication.getDescription(), "description...");
        ...
        Container pub = BoxLayout.encloseY(
                BorderLayout.center(
                        BoxLayout.encloseY(
                                titre, description, image, addPub
                        )
                )
        );
        ...
        addPub.addActionListener(l -> {
            if (titre.getText().equals("") || description.getText().equals("") || image.getText().equals("")) {
