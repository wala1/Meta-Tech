...
public class EditComment extends SideMenuBaseForm {
    ...
    public EditComment(Resources res, Commentaire commentaire) {
        ...
        TextField titre = new TextField(commentaire.getDescription(), "Commentaire ...");
        ...
        addPub.addActionListener(l -> {
            if (titre.getText().equals("")) {
                ...
                commentaire.setDescription(titre.getText());

                ServiceComment.getInstance().editPub(commentaire);
                iDialog.dispose();
