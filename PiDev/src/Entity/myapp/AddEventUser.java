 ...
 * @author wala
 */
public class AddEventUser extends SideMenuBaseForm  {
 public AddEventUser(Resources res, Form previous) {
 ...
 super(BoxLayout.y());
        ...
        this.getToolbar().addCommandToRightBar("Back", null, (evt) -> {
           ...
           Label lblImage = new Label();
            ...
            Button add = new Button("Send Request");
                ...
                public void actionPerformed(ActionEvent evt) {
                    if ((titleEv.getText().length() == 0) || (description.getText().length() == 0) || (datePicker.getDate().toString().length() == 0) || (datePicker1.getDate().toString().length() == 0) || (imageEvent.getText().length() == 0)) {
                        ...
                        try {
                            ...
                            if (ServiceEvents.getInstance().ajoutEventser(t)) {
                                Dialog.show("Request Sent!", "We have notified the Admin of your request , wait for administrator approval", new Command("OK"));
