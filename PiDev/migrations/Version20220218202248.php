 ...
 */
final class Version20220218202248 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reclamation CHANGE traite_reclamation traite_reclamation INT DEFAULT NULL');
    }
