 ...
 */
final class Version20220215024510 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE panier DROP produit_panier_id');
        ...
        $this->addSql('ALTER TABLE produit DROP panier_prod_id');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE panier ADD produit_panier_id INT DEFAULT NULL');
