 ...
 */
final class Version20220212090242 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE sous_categorie ADD nom_sous_categ VARCHAR(255) NOT NULL, DROP categorie_prod_id');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE sous_categorie ADD categorie_prod_id INT NOT NULL, DROP nom_sous_categ');
    }
}
