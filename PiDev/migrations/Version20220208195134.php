 ...
 */
final class Version20220208195134 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE produit ADD sous_categ_prod VARCHAR(255) NOT NULL, DROP sous_categorie_id');
    }
