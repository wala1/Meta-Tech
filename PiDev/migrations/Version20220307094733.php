 ...
 */
final class Version20220307094733 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE produit CHANGE model_prod model_prod VARCHAR(1500) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE avis DROP FOREIGN KEY FK_8F91ABF0DF559605');
