 ...
 */
final class Version20220221045005 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE produit ADD quantite_prod INT NOT NULL');
    }
