 ...
 */
final class Version20220218185123 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reclamation ADD traite_reclamation INT DEFAULT NULL');
    }
