 ...
 */
final class Version20220212222204 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE coupon CHANGE code_coupon code_coup VARCHAR(255) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE coupon ADD code_coupon VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, DROP code_coup');
