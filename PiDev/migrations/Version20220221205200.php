 ...
 */
final class Version20220221205200 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE pub_back ADD produit_id INT DEFAULT NULL');
