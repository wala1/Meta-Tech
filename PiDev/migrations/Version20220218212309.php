 ...
 */
final class Version20220218212309 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE avis CHANGE time_avis time_avis DATETIME NOT NULL');
        $this->addSql('ALTER TABLE produit ADD stock_prod INT DEFAULT NULL');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('ALTER TABLE avis CHANGE desc_avis desc_avis VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE time_avis time_avis DATETIME DEFAULT CURRENT_TIMESTAMP');
