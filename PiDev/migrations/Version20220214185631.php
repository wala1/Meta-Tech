 ...
 */
final class Version20220214185631 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE panier ADD user_id INT DEFAULT NULL, DROP produit_panier_id, DROP user_panier_id');
        ...
        $this->addSql('ALTER TABLE produit ADD quantite_prod VARCHAR(255) DEFAULT NULL, DROP panier_prod_id');
