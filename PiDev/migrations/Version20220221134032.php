 ...
 */
final class Version20220221134032 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD phone_number BIGINT NOT NULL');
    }
