...
System.out.println("get data session (connexion) "+User.session);
    }
    ...
    private void OnLogin(ActionEvent event) throws IOException {
        System.out.println("get Data from session   "+User.session);
...
//if (ServiceUser.login(u.getEmail(), u.getPassword())) {
        if (ServiceUser.login1(email,pass) != null) {
            u = ServiceUser.login1(email,pass);
            User.session = u;
            System.out.print("session   "+u);
...
//            
                    ...
                    try {
                        ...
                        FXMLLoader loader = new FXMLLoader(getClass().getResource("MetatechFront.fxml"));
